...
| `media.rs` | `read_cdb`, `write_cdb`, `read_text_file`, `write_file`, `path_exists`, `list_image_folder_entries`, `copy_image`, `read_image`, `import_card_image`, `load_strings_conf`, `open_in_system_editor`, `open_in_default_app` | File I/O, image operations, string resource loading |
